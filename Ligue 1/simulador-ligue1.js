const teams = ['Paris Saint-Germain', 'Lille', 'Lyon', 'Olympique Marseille', 'AS Monaco', 'OGC Niza', 'Rennes', 'Angers',
'Brest', 'Lens', 'Montpellier', 'Nantes', 'Racing Strasbourg', 'Stade de Reims', 'Ajaccio', 'Auxerre', 'Clermont Foot',
'Lorient', 'Toulouse', 'Troyes']

const powerhouse = ['Paris Saint-Germain']
const challenger = ['Lille', 'Lyon', 'Olympique Marseille', 'AS Monaco', 'OGC Niza', 'Rennes']
const midtable = ['Angers', 'Brest', 'Lens', 'Montpellier', 'Nantes', 'Racing Strasbourg', 'Stade de Reims']
const survival = ['Ajaccio', 'Auxerre', 'Clermont Foot', 'Lorient', 'Toulouse', 'Troyes']
