const teams = ['Atlético Mineiro', 'Corinthians', 'Flamengo', 'Internacional', 'Palmeiras', 'Athletico Paranaense', 
'Fluminense', 'São Paulo', 'Santos', 'Red Bull Bragantino', 'America MG', 'Atlético Goianiense', 'Botafogo', 'Ceará',
'Fortaleza', 'Goiás', 'Avaí', 'Coritiba', 'Cuiabá', 'Juventude']

const powerhouse = ['Atlético Mineiro', 'Corinthians', 'Flamengo', 'Internacional', 'Palmeiras']
const challenger = ['Athletico Paranaense', 'Fluminense', 'São Paulo', 'Santos', 'Red Bull Bragantino']
const midtable = ['America MG', 'Atlético Goianiense', 'Botafogo', 'Ceará', 'Fortaleza', 'Goiás']
const survival = ['Avaí', 'Coritiba', 'Cuiabá', 'Juventude']
