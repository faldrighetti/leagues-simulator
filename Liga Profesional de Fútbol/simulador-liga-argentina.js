const teams = ['Boca Juniors', 'River Plate', 'Colón', 'Defensa y Justicia', 'Estudiantes LP', 'Lanús', 'Racing Club', 'Talleres',
'Vélez Sarsfield', 'Atlético Tucumán', 'Argentinos Juniors', 'Banfield', 'Gimnasia LP', 'Huracán', 'Independiente', 'Newell\'s', 'San Lorenzo',
'Rosario Central', 'Tigre', 'Unión', 'Aldosivi', 'Arsenal', 'Barracas Central', 'Central Córdoba', 'Godoy Cruz', 'Patronato', 'Platense',
'Sarmiento']

const powerhouse = ['Boca Juniors', 'River Plate']
const challenger = ['Colón', 'Defensa y Justicia', 'Estudiantes LP', 'Lanús', 'Racing Club', 'Talleres', 'Vélez Sarsfield']
const midtable = ['Atlético Tucumán', 'Argentinos Juniors', 'Banfield', 'Gimnasia LP', 'Huracán', 'Independiente', 'Newell\'s', 'San Lorenzo',
'Rosario Central', 'Tigre', 'Unión']
const survival = ['Aldosivi', 'Arsenal', 'Barracas Central', 'Central Córdoba', 'Godoy Cruz', 'Patronato', 'Platense', 'Sarmiento']
