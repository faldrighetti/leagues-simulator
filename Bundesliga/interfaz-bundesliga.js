...
function placeTeams(){
    ...
    for (i = 0; i < finalStandings.length; i++){
        ...
        if (i === 0){
            ...
            championsLeague.textContent = 'UEFA Champions League: ' + finalStandings[i-3][0] + ', ' + finalStandings[i-2][0] + ', ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
            ...
            europaLeague.textContent = 'UEFA Europa League: ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
            ...
            relegated.textContent = 'Descenso: ' + finalStandings[i-2][0] + ', ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
