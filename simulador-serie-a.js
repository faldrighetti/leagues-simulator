const teams = ['Milan', 'Inter', 'Atalanta', 'Fiorentina', 'Juventus', 'Lazio', 'Napoli', 'Roma', 'Bologna', 'Empoli',
'Hellas Verona', 'Sassuolo', 'Sampdoria', 'Torino', 'Udinese', 'Cremonese', 'Lecce', 'Monza', 'Salernitana', 'Spezia']

const powerhouse = ['Milan', 'Inter']
const challenger = ['Atalanta', 'Fiorentina', 'Juventus', 'Lazio', 'Napoli', 'Roma']
const midtable = ['Bologna', 'Empoli', 'Hellas Verona', 'Sassuolo', 'Sampdoria', 'Torino', 'Udinese']
const survival = ['Cremonese', 'Lecce', 'Monza', 'Salernitana', 'Spezia']
