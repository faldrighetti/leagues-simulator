const teams = ['Atlético de Madrid', 'Barcelona', 'Real Madrid', 'Athletic Club', 'Real Betis', 'Real Sociedad', 'Sevilla',
'Valencia', 'Villarreal', 'Celta de Vigo', 'Elche', 'Espanyol', 'Getafe', 'Osasuna', 'Rayo Vallecano',  'Almería', 'Cádiz',
'Mallorca', 'Girona', 'Valladolid']

const powerhouse = ['Atlético de Madrid', 'Barcelona', 'Real Madrid']
const challenger = ['Athletic Club', 'Real Betis', 'Real Sociedad', 'Sevilla', 'Valencia', 'Villarreal']
const midtable = ['Celta de Vigo', 'Elche', 'Espanyol', 'Getafe', 'Osasuna', 'Rayo Vallecano']
const survival = ['Almería', 'Cádiz', 'Mallorca', 'Girona', 'Valladolid']
